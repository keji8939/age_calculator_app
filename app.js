...
btn.addEventListener('click',(e)=>{
    ...
    if(day.value == '' || month.value == ''|| year.value ==''){
        ...
        day_err.textContent = 'day required a number';
    }else if (isNaN(month.value)){
        month_err.textContent = 'day required  a number';
    }else if (isNaN(year.value)){
        year_err.textContent ='year  required a number';
        ...
        year_err.textContent = 'must be a valid past'
    }else{
        ...
        const user_day = current_day-  year.value;
        year_result.textContent= user_day;
